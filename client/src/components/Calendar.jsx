...
function Calendar (props) {
  ...
  const { messagesCalendar } = useWSStore()
    ...
    <Box>
      <Box sx={{ textAlign: 'center' }}>
        ...
        <Box sx={{
          ...
          {days.map((day, index) => {
            let messagesOfThisDay = messagesCalendar.filter(
              ...
              <Box
                ...
                onClick={() => {
                  ...
                  openModal(CalendarDayModal,
                    { currentData: { date: dayjs(day).format('YYYY-MM-DD'), messages: messagesOfThisDay } })
                }}
                sx={{
